...
- 2000: [Lasserre's hierarchy](https://en.wikipedia.org/wiki/Sum-of-squares_optimization) (Jean-Bernard Lasserre, Pablo Parillo)
...
- 1880: [Depth-first search](https://en.wikipedia.org/wiki/Depth-first_search) (Charles Pierre Trémaux)
- 1887: [Radix sort](https://en.wikipedia.org/wiki/Radix_sort) (Herman Hollerith)
- 1930: [Prim minimum spanning tree](https://en.wikipedia.org/wiki/Prim%27s_algorithm) (Vojtěch Jarník, Robert Prim)
- 1945: [Breadth-first search](https://en.wikipedia.org/wiki/Breadth-first_search) (Konrad Zuse, Michael Burke)
...
- 1956: [Kruskal minimum-spanning-tree](https://en.wikipedia.org/wiki/Kruskal%27s_algorithm) (Joseph Kruskal)

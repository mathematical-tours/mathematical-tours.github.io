...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approximation/proposed.pdf}
\caption{Linear versus nonlinear wavelet approximation.}
...
\myfigure{
\BookDrawing{chapter-linear-and-nonlinear-approximation/thresholding-hard/original/approximation-hard-threshold.pdf}
}{%
	Hard thresholding.%	
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approximation-class/proposed.pdf}
\caption{Examples of image models. The bounded-variation example is generated by ROF total-variation denoising of white noise.}
\label{fig-approximation-class}
\end{figure}
...
Figure~\ref{fig-signal-model-sobolev} shows progressively smoother images obtained by Gaussian filtering of the same white-noise realization. Each result is rescaled to the same mean and variance, so the comparison emphasizes spatial regularity rather than a loss of contrast.

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/signal-model-sobolev/proposed.pdf}
\caption{Progressive Gaussian filtering of one white-noise image. Smoothing widths increase from left to right; the displayed images have the same mean and variance.}
\label{fig-signal-model-sobolev}
\end{figure}
...
Figure~\ref{fig-image-model-cartoon} illustrates a progressive dead-leaves construction: opaque shapes are placed successively, producing smooth visible contour segments and occlusion boundaries.

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/image-model-cartoon/proposed.pdf}
\caption{Progressive dead-leaves construction: later opaque shapes cover earlier ones, producing a family of cartoon images.}
\label{fig-image-model-cartoon}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/sample-cartoon/proposed.pdf}
\caption{A grayscale frame from \emph{Feline Follies} (1919), a mathematical jump along a smooth graph, and a Gaussian-smoothed cartoon. Film frame: Pat Sullivan, via Wikimedia Commons, public domain.}
\label{fig-sample-cartoon}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approx-speed-1/proposed.pdf}
\caption{Test images with different structures: smooth, cartoon, flower, and mandrill.}
\label{fig-approx-speed-1}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approx-speed/proposed.pdf}
\caption{Wavelet approximation error for the images in Figure \ref{fig-approx-speed-1}.}
\label{fig-approx-speed}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approx-effi-1/proposed.pdf}
\caption{Fourier, DCT, and wavelet approximations of the same $256\times256$ flower image, each retaining $M=4096$ real orthonormal coefficients.}
\label{fig-approx-effi-1}
\end{figure}

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approx-effi/proposed.pdf}
\caption{Comparison of approximation error decay for different bases.}
\label{fig-approx-effi}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-linear-and-nonlinear-approximation/approx-comparaison/original/approximation-rates.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/fourier-approximation-1d/proposed.pdf}
\caption{Fourier approximation of a signal.}
\label{fig-ourier-approx-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/fourier-approx-2d-linnonlin/proposed.pdf}
\caption{Linear (top row) and nonlinear (bottom row) Fourier approximation.}
\label{fig-fourier-approx-2d-linnonlin}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/singular-part/proposed.pdf}
\caption{Singular and regular regions of a signal (left) and an image (right).}
\label{fig-singular-part}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/singular-support-1d/proposed.pdf}
\caption{Segmentation of the wavelet coefficients into regular and singular parts.}
\label{fig-singular-support-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/wav-approx-1d/proposed.pdf}
\caption{1-D wavelet approximation.}
\label{fig-wav-approx-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/approx-2d-wav/proposed.pdf}
\caption{2-D wavelet approximation.}
\label{fig-approx-2d-wav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/cartoon-wav/proposed.pdf}
\caption{Wavelet approximation of a cartoon image.}
\label{fig-cartoon-wav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/triangulation-image/proposed.pdf}
\caption{A cartoon with smooth variation on both sides of an elliptical jump, a triangulation elongated along that boundary, and the continuous $P_1$ interpolant.}
\label{fig-triangulation-image}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/triangulation-anisoiso/proposed.pdf}
\caption{The same mesh over a lightened $P_1$ interpolant (left), with the boxed boundary region enlarged (right). Thin triangles follow the red singularity curve; the arrow indicates its tangent. Smooth regions use nearly equilateral elements.}
\label{fig-triangulation-anisoiso}
\end{figure}
...
Figure~\ref{fig-triangulation-peppers} uses a known synthetic contour to isolate the effect of mesh geometry. Both regions have smooth, nonaffine intensities. The displayed $P_1$ image is decoded from an explicit mesh stream whose bit count includes vertex coordinates, values, connectivity, and headers; this example does not assume an optimal mesh code.

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/triangulation-peppers/proposed.pdf}
\caption{Compression of a piecewise-smooth cartoon using a contour-aligned mesh and JPEG-2000 at the same transmitted bit budget. From left to right: original, mesh, decoded $P_1$ image, and JPEG-2000 image. Mesh costs include coordinates, nodal values, connectivity, and headers.}
\label{fig-triangulation-peppers}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/curvelet/proposed.pdf}
\caption{A curvelet $c_m$ in space (left) and its localization in the Fourier domain (right).}
\label{fig-curvelet}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/curvelet-discretization/proposed.pdf}
\caption{Sampling pattern for the curvelet positions.}
\label{fig-curvelet-discretization}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/curvelets-vs-wavelets/proposed.pdf}
\caption{Wavelet (left) and curvelet (right) approximation of a cartoon image.}
\label{fig-curvelets-vs-wavelets}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-linear-and-nonlinear-approximation/curvelet-denoising/proposed.pdf}
\caption{Comparison of translation-invariant wavelet denoising and curvelet denoising.}
\label{fig-curvelet-denoising}
\end{figure}

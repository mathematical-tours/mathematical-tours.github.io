...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/noise-examples/proposed.pdf}
\caption{Gaussian, Poisson, and multiplicative Gamma noise simulated on the same flower image.}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/additive-noise-model/proposed.pdf}
\caption{Image acquisition, noise, and reconstruction by denoising.}
\label{fig-additive-noise-model}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/noise-example-1d/proposed.pdf}
\caption{One-dimensional additive Gaussian noise at low, medium, and high levels, with a common clean signal and normalized noise realization.}
\label{fig-noise-example-1d}
\end{figure}


\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/noise-example-2d/proposed.pdf}
\caption{Two-dimensional additive noise: the clean image $f_0$ and the observation $f=f_0+w$, with $w\sim\mathcal N(0,\sigma^2 I)$.}
\label{fig-noise-example-2d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/denoising-clean/proposed.pdf}
\caption{Left: clean image, center: noisy image, right: denoised image.}
\label{fig-denoising-clean}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/filtering-denoised/proposed.pdf}
\caption{Gaussian filtering: noisy signal, kernel, and filtered signal (top), with their Fourier magnitudes below.}
\label{fig-filtering-denoised}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/filtering-progression/proposed.pdf}
\caption{Gaussian filtering with increasing width: three signals (top) and five images (bottom).}
\label{fig-filtering-progression}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/filtering-optimal-curves/proposed.pdf}
\caption{SNR as a function of filter width for a signal (left) and an image (right).}
\label{fig-iltering-optimal-curve}
\end{figure}

Figure~\ref{fig-filtering-optimal-1d} uses the width $s^\star$ that maximizes SNR for the displayed observation. This choice uses the known clean signal to assess the best achievable result within the filter family.

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/filtering-optimal-1d/proposed.pdf}
\caption{Gaussian filtering at the SNR-optimal widths. From left to right: noisy signal, filtered signal, noisy image, and filtered image.}
\label{fig-filtering-optimal-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/wavthresh/proposed.pdf}
\caption{Denoising using thresholding of wavelet coefficients.}
\label{fig-wavthresh}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/wavthresh-2d-hard-vs-soft/proposed.pdf}
\caption{SNR as a function of $T/\si$ for hard and soft thresholding.}
\label{fig-wavthresh-2d-hard-vs-soft}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/wavthresh-2d/proposed.pdf}
\caption{Comparison of hard (left) and soft (right) thresholding.}
\label{fig-wavthresh-2d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/sparse-signal/proposed.pdf}
\caption{Left: clean sparse coefficients $a_0$; right: noisy coefficients $a$.}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/max-gaussian-mean/proposed.pdf}
\caption{Empirical mean (top) and standard deviation (bottom) of the largest absolute Gaussian noise coefficient.}
\label{fig-max-gaussian-mean}
\end{figure}
...
\begin{center}
	\includegraphics[width=.72\linewidth,height=.25\textheight,keepaspectratio]{chapter-denoising/cycle-spin-principle/proposed.pdf}
\end{center}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/wavthresh-2d-soft-ti/proposed.pdf}
\caption{Soft thresholding in an orthogonal wavelet basis (left) and translation-invariant hard thresholding (right).}
\label{fig-wavthresh-2d-soft-ti}
\end{figure}


\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/wavthresh-ti/proposed.pdf}
\caption{SNR as a function of $T/\si$ for translation-invariant thresholding.}
\label{fig-wavthresh-ti}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/tiwav/proposed.pdf}
\caption{Translation invariant wavelet coefficients.}
\label{fig-tiwav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/tiwav-coefs-thresh/proposed.pdf}
\caption{Left: translation invariant wavelet coefficients, for $j=-8, \om=H$, right: thresholded coefficients.}
\label{fig-tiwav-coefs-thresh}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/semisoft/proposed.pdf}
\caption{Left: semi-soft thresholder, right: Stein thresholder.}
\label{fig-semisoft}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/semisoft-optimal/proposed.pdf}
\caption{Left: SNR as a function of $\mu$ and $T/\si$. Right: SNR versus $\mu$, with $T/\si$ optimized separately for each $\mu$.}
\label{fig-semisoft-optimal}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/stein-optimal-curve/proposed.pdf}
\caption{SNR as a function of $T/\si$ for Stein thresholding.}
\label{fig-stein-optimal-curve}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/block-wavcoefs/proposed.pdf}
\caption{Left: wavelet coefficients, center: block thresholded coefficients, right: denoised image.}
\label{fig-block-wavcoefs}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/block-optimal-curves/proposed.pdf}
\caption{SNR as a function of $T/\si$ (left) and comparison of different block sizes (right).}
\label{fig-block-optimal-curves}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/comp-thresh/proposed.pdf}
\caption{Left: translation invariant wavelet hard thresholding, center: block orthogonal Stein thresholding,
	 right: block translation invariant Stein thresholding.}
\label{fig-comp-thresh}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/poisson-distrib/proposed.pdf}
\caption{Poisson distributions for various $\la$.}
\label{fig-poisson-distrib}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/poisson-denoising/proposed.pdf}
\caption{Poisson-corrupted flower images at increasing photon-count scales $\lambda_{\max}$.}
\label{fig-poisson-denoising}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/variance-stabilization/proposed.pdf}
\caption{Exact Poisson variances of the Anscombe, Freeman--Tukey, and $2\sqrt{x}$ transforms as functions of the mean intensity.}
\label{fig-variance-stabilization}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/poisson-wav/proposed.pdf}
\caption{Left: noisy image, center: denoising without variance stabilization, right: denoising after variance stabilization.}
\label{fig-poisson-wav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/multnoise/proposed.pdf}
\caption{Multiplicative Gamma noise for increasing numbers $K$ of averaged looks, with standard deviation $\sigma=K^{-1/2}$.}
\label{fig-multnoise}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/multnoise-hist-unstab/proposed.pdf}
\caption{Histogram of multiplicative noise before (left) and after (right) stabilization.}
\label{fig-multnoise-hist-unstab}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-denoising/multnoise-wav/proposed.pdf}
\caption{Left: noisy image, center: denoising after variance stabilization, right: denoising without variance stabilization.}
\label{fig-multnoise-wav}
\end{figure}

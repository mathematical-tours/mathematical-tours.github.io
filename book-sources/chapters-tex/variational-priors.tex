...
Figure \ref{fig-grad-discrete} shows discrete gradient vectors approximating the local direction of steepest intensity increase. Figure~\ref{fig-discrete-operators} displays the signed gradient components and their Euclidean magnitude. A shared nonlinear display curve enhances weak red and blue components without changing the numerical gradient. Large magnitudes indicate rapid intensity variations, typically at edges or in textured regions.

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/grad-discrete/proposed.pdf}
\caption{Discrete gradient vectors.}
\label{fig-grad-discrete}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/discrete-operators/proposed.pdf}
\caption{Discrete gradient of the flower image. Red and blue encode the signed horizontal and vertical components with enhanced display contrast; neutral gray represents zero. The last panel shows the Euclidean gradient magnitude.}
\label{fig-discrete-operators}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/flow/proposed.pdf}
\caption{Heat flow (top) and TV flow (bottom): images $f_t$ at increasing times $t$.}
\label{fig-flow}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/discrete-operators-lapl/proposed.pdf}
\caption{Discrete Laplacian (left) and negative discrete TV gradient (right).}
\label{fig-discrete-operators-lapl}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookPanel{.485}{1}{chapter-variational-priors-and-regularization/regul-abs/original/variational-smoothed-absolute-1.pdf}\hfill
\BookPanel{.485}{2}{chapter-variational-priors-and-regularization/regul-abs/original/variational-smoothed-absolute-2.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/discrete-operators-tveps/proposed.pdf}
\caption{Regularized gradient norm $\sqrt{ \norm{\nabla f(x)}^2 + \epsilon^2 }$.}
\label{fig-discrete-operators-tveps}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/denoising-flow/proposed.pdf}
\caption{Denoised images $f_t$ at several times $t$: Sobolev flow (top) and TV flow (bottom).}
\label{fig-denoising-flow}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/denoising-cameraman/proposed.pdf}
\caption{Denoising using PDE flows and regularization.}
\label{fig-denoising-cameraman}
\end{figure}

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-variational-priors-and-regularization/denoising-cameraman-snr/proposed.pdf}
\caption{SNR as a function of time $t$ for flows (top) and $\la$ for regularization (bottom).}
\label{fig-denoising-cameraman-snr}
\end{figure}

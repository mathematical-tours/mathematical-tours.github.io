...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-optimization-and-machine-learning-smooth-optimization/minimizer-exists/original/smooth-minimizer-examples.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-optimization-and-machine-learning-smooth-optimization/cvx-set/original/smooth-convex-examples.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-optimization-and-machine-learning-smooth-optimization/smooth-gradient-field/original/smooth-gradient-field.pdf}
...
\begin{figure}[tbp]
\centering
\BookPanel{.315}{1}{chapter-optimization-and-machine-learning-smooth-optimization/first-order/original/smooth-stationary-extrema.pdf}\hfill
\BookPanel{.315}{2}{chapter-optimization-and-machine-learning-smooth-optimization/first-order/original/smooth-stationary-inflection.pdf}\hfill
\BookPanel{.315}{3}{chapter-optimization-and-machine-learning-smooth-optimization/first-order/original/smooth-stationary-convex.pdf}
...
\begin{figure}[tbp]
\centering
\BookPanel{.485}{1}{chapter-optimization-and-machine-learning-smooth-optimization/expansion-taylor/original/smooth-taylor-line.pdf}\hfill
\BookPanel{.485}{2}{chapter-optimization-and-machine-learning-smooth-optimization/expansion-taylor/original/smooth-taylor-plane.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-optimization-and-machine-learning-smooth-optimization/grad-desc-contract/original/smooth-quadratic-contraction.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-optimization-and-machine-learning-smooth-optimization/smooth-curvature-bounds/original/smooth-curvature-bounds.pdf}

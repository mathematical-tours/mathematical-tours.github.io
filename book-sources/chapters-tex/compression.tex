...
\myfigure{
\BookDrawing{chapter-compression/thresholding-vs-quantizing/original/compression-threshold-quantization.pdf}
}{%
...
\begin{center}
\includegraphics[width=.9\linewidth,height=.55\textheight,keepaspectratio]{chapter-compression/quantization-bins/proposed.pdf}
\end{center}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-compression/compression/proposed.pdf}
\caption{Image compression using wavelet support coding.}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-compression/jpeg-2k-architecture/proposed.pdf}
\caption{JPEG-2000 coding architecture.}
\label{fig-jpeg-2k-architecture}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-compression/compression-jpeg/proposed.pdf}
\caption{JPEG and JPEG-2000 reconstructions of the flower (first pair) and mandrill (second pair), at matched target bit rates.}
\label{fig-compression-jpeg}
\end{figure}

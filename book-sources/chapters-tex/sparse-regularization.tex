...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/sparsity-wav/proposed.pdf}
\caption{Most wavelet coefficients of a natural image have small magnitude.}
\label{fig-sparsity-wav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/sparsity-lq/proposed.pdf}
\caption{$\ell ^q$ balls $\enscond {x}{J_q(x) \leq 1}$ for varying $q$.}
\label{fig-sparsity-lq}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookPanel{.485}{1}{chapter-sparse-regularization/varspars/original/sparse-regularization-hard-objective.pdf}\hfill
\BookPanel{.485}{2}{chapter-sparse-regularization/varspars/original/sparse-regularization-soft-objective-1.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/optim-geom/proposed.pdf}
\caption{Geometry of convex optimization: smooth-boundary and corner contact with objective level sets, followed by the smallest scaled $\ell^2$ and $\ell^1$ balls touching an affine constraint. Red dots mark the contact points.}
\label{fig-optim-geom}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/spikes-lun/proposed.pdf}
\caption{Sparse spike recovery by the pseudoinverse and by $\lun $ regularization.}
\label{fig-spikes-lun}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/spikes-ista-decay/proposed.pdf}
\caption{Convergence of the energy and iterates under iterative soft thresholding.}
\label{fig-spikes-ista-decay}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/deconvolution-1d/proposed.pdf}
\caption{One-dimensional deconvolution with sparsity in an orthogonal wavelet basis.}
\label{fig-deconvolution-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/deconvolution-2d/proposed.pdf}
\caption{Image deconvolution.}
\label{fig-deconvolution-2d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/deconvolution-2d-snr/proposed.pdf}
\caption{Reconstruction SNR as a function of the regularization parameter $\lambda$, swept logarithmically from $10^{-5}$ to $1$. Red dots mark the measured maxima.}
\label{fig-deconvolution-2d-snr}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-sparse-regularization/inpainting-lena/proposed.pdf}
\caption{Inpainting with Sobolev and wavelet sparsity priors.}
\label{fig-inpainting-lena}
\end{figure}

...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-shannon-sampling-theory/examples-1/proposed.pdf}
\caption{Examples of sound ($d=1$), an image ($d=2$), and a video ($d=3$).}
\label{fig-examples-1}
\end{figure}

\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-shannon-sampling-theory/examples-2/proposed.pdf}
\caption{A color flower image and a synthetic multispectral image with 32 channels, with an example spectrum.}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-shannon-sampling-theory/discretization/proposed.pdf}
\caption{Spatial and temporal detail: a flower image with a pixelated crop, and a recorded birdsong waveform with a short-time enlargement. Matching red boxes identify the spatial crop.}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-shannon-sampling-theory/sampling-aliasing/original/shannon-sampling-aliasing.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-shannon-sampling-theory/shannon-sinc/original/shannon-sinc.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-shannon-sampling-theory/sampling-splines/original/shannon-splines.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-shannon-sampling-theory/aliasing/original/shannon-aliasing.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-shannon-sampling-theory/section3-quantize/proposed.pdf}
\caption{Quantizing an image with $K\in\{2,3,4,16\}$ gray levels. The normalized intensities lie in $[0,1)$; finite-level quantizers also specify clipping or endpoint conventions.}
\label{fig-section3-quantize}
\end{figure}

...
Denoting $c_k \coloneqq \dotp{f_0}{\psi_k}$ (for the Fourier basis, $c=\hat f_0$), the expected risk of this denoiser is
$$
...
\eq{
	\mathbb{E}_{w,F}  \|\Dd(F+w) - F\|^2   \sum_k  \alpha_k |\lambda_k - 1|^2 + |\lambda_k|^2 \sigma^2 
	\quad\text{where}\quad

...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-fourier-and-convolution/fourier-wav/proposed.pdf}
\caption{Fourier modes (left) and several translated Daubechies wavelets at each scale (right).}
\label{fig-fourier-wav}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-transforms/original/fourier-four-settings.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-fourier-and-convolution/filtering-1d/proposed.pdf}
\caption{Filtering an irregular signal with Gaussian filters of increasing width $\si$.}
\label{fig-filtering-1d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/splines/original/fourier-splines.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-translation-inv/original/fourier-translation-inv.pdf}
...
\caption{Interpolation by zero-padding in the frequency domain.}
\label{fig-padding-fourier}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-wave/original/fourier-wave.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-fourier-and-convolution/2d-fourier-extension/proposed.pdf}
\caption{2D Fourier orthogonal bases.}
\label{fig-2d-fourier-extension}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-torus/original/fourier-torus.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-torus-discrete/original/fourier-torus-discrete.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\linewidth,height=.62\textheight,keepaspectratio]{chapter-fourier-and-convolution/fourier-2d/proposed.pdf}
\caption{2-D Fourier analysis of an image (left), and attenuation of the periodicity artifact using masking (right).}
\label{fig-fourier-2d}
\end{figure}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/heat/original/fourier-heat.pdf}
...
\begin{figure}[tbp]
\centering
\BookDrawing{chapter-fourier-and-convolution/fourier-finite-difference-spectrum/original/fourier-finite-difference-spectrum.pdf}

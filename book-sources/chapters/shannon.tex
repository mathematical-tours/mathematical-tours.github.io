...
\myfigure{
	...
	Spectral view of sampling, reconstruction, and aliasing in Theorem~\ref{thm-shannon-sampling}. %
...
\wrapf{1-shannon/sinc}{The sinc interpolation kernel.}
...
\myfigure{
	...
	Aliasing of a sine wave. This periodic example is interpreted through its discrete spectral lines rather than as an $L^2(\RR)$ signal. %
}{fig-aliasing}
...
\wrapf{1-shannon/quantizer}{A uniform scalar quantizer.}

...
\draw[curve]plot[domain=0:4.3,samples=90](\x,{3.4*\x/(1+\x*\x)});
\draw[guide](1,0)node[below]{$\sqrt\lambda$}--(1,1.7)--(0,1.7)node[left]{$\frac1{2\sqrt\lambda}$};
\fill[accent](1,1.7)circle(1.5pt);
\draw[guide]plot[domain=1.3:4.3,samples=60](\x,{3.4/\x});\node[muted]at(2.1,2.0){$1/\sigma$};

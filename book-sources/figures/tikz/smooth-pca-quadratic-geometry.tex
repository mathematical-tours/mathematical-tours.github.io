...
\path[use as bounding box] (-3,-3.25) rectangle (8.8,3.6);\begin{scope}[shift={(0.0,0)}]
...
\end{scope}
\node at (0,3.15) {Data covariance};
\node[font=\footnotesize] at (0,2.65) {Width along $u_i\ \propto\sqrt{\lambda_i}$};
...
\draw[->,ink] (-2.3,0)--(2.4,0) node[right] {$u_1$};\draw[->,ink] (0,-2.0)--(0,2.2) node[above] {$u_2$};
\end{scope}
\node at (0,3.15) {Quadratic level sets};
\node[font=\footnotesize] at (0,2.65) {Width along $u_i\ \propto1/\sqrt{\lambda_i}$};

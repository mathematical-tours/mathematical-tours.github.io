...
\draw[signalred,fill=white,line width=1pt] (3.5,-3) circle(3pt);
...
\node[font=\scriptsize] at (0,-4.25) {A codeword of length $\ell$ reserves $2^{m-\ell}$ leaves at depth $m$.};
\node at (0,-4.95) {$c=(0,10,110,111),\qquad\frac12+\frac14+\frac18+\frac18=1$};
\end{tikzpicture}
\end{document}

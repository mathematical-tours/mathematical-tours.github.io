...
\fill[accent!15] (-3.85,-3.42) rectangle (-0.15000000000000002,-2.8);
\fill[signalred!14] (0.15000000000000002,-3.42) rectangle (1.85,-2.8);
\fill[accent!30] (2.15,-3.42) rectangle (2.85,-2.8);
\fill[signalred!28] (3.15,-3.42) rectangle (3.85,-2.8);
...
\draw[accent,fill=white,line width=1pt] (1,-2) circle(3pt);
\node[above=4pt,fill=white,inner sep=1pt] at (1,-2) {$c_2=10$};
\draw[accent,fill=white,line width=1pt] (2.5,-3) circle(3pt);
\draw[accent,fill=white,line width=1pt] (3.5,-3) circle(3pt);
...
\node[below=6pt] at (3.5,-3.55) {$1$};
\node at (0,-4.65) {$c=(0,10,110,111),\qquad\frac12+\frac14+\frac18+\frac18=1$};
\end{tikzpicture}
\end{document}

...
\node at(.65,2.8){$d_0=3$};\node at(3.05,2.8){$d_1$};\node at(5.45,2.3){$d_1$};\node at(7.7,2.45){$d_2$};\node at(9.9,2.2){$d_2$};
\draw[->](1.45,1.1)--(2.1,1.1)node[midway,above,align=center,font=\footnotesize]{conv.\\$\widetilde\rho_0$};
\draw[->](3.9,1.1)--(4.6,1.1)node[midway,above]{$\downarrow m_0$};
\draw[->](5.95,1.1)--(6.75,1.1)node[midway,above,align=center,font=\footnotesize]{conv.\\$\widetilde\rho_1$};

...
\begin{document}
\begin{tikzpicture}[x=0.8cm,y=0.8cm,every node/.style={font=\footnotesize}]
\draw[accent,line width=.7pt] (0,0) ellipse (1 and 0.7);
...
\node[align=center] at (1,-2.65) {Gradients point toward larger values.\\[3pt]Arrow lengths are schematic.};
\end{tikzpicture}
\end{document}

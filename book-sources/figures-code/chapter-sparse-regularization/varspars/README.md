...
```sh
build/figure-runtime/bin/python scripts/regenerate_figures.py --id sparse-regularization--varspars
```
...
```sh
build/figure-runtime/bin/python scripts/regenerate_figures.py --id sparse-regularization--varspars-continued
```

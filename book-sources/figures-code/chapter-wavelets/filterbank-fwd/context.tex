...
able when the scaling functions $(\phi_{J,n})_n$ approximate the acquisition device's point-spread function. Preprocessing the measurements can sometimes improve agreement with~\eqref{eq-hyp-wav-samples}.

...
\draw[curve]plot[domain=0:3.2,samples=85](\x,{exp(-((\x-.8)/.35)^2)});
\draw[signalred]plot[domain=0:3.2,samples=85](\x,{exp(-((\x-2.35)/.35)^2)});
...
\draw[axis](0,0)--(2.9,0)node[right]{$z$};
\draw[accent,->](.8,0)--(.8,1.9)node[above]{$x_j$};\draw[signalred,->](2.35,0)--(2.35,1.15)node[above]{$x_i$};
\node[below]at(.8,0){$z_j$};\node[below]at(2.35,0){$z_i$};

function [S,conjuguee] = LFt(F,a,b,n,c,d,m)
% LFt		Compute numerically the convex conjugate of a
...
%		equidistant points on [c,d]. It runs in linear time.
%
% Usage:
%  [S,conjuguee] = LFt(F,a,b,n,c,d,m)
%
% Input parameters:
...
[S,conjuguee] = LLTd(X,Y,S); % Compute the discrete Legendre Transform

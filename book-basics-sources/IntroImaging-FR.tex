...
\title{\Huge \sf Une introduction aux sciences de l'imagerie\vspace{1cm}
...
\input{chap-fr/abstract}
\input{chap-fr/shannon}
\input{chap-fr/images}
\input{chap-fr/sparsity}
